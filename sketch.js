...
function preload()
{
  ...
  eat2 = loadAnimation("eat_0.png" , "eat_1.png","eat_2.png","eat_3.png","eat_4.png");
...
function setup() {
 ...
 cutBtn.position(200,320)
 cutBtn.size(50,50)
 cutBtn.mouseClicked(remove_rope)
 

 cutBtn2 = createImg('cut_btn.png')
 cutBtn2.position(30,420)
 cutBtn2.size(50,50)
 cutBtn2.mouseClicked(drop)
